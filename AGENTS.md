...
6. **UI/UX First Principles**: Adhere to `docs/design-system/first-principles-ui-ux.md` (hierarchy, proximity, base-4/8 spacing, soft tinted shadows, 45-75ch measure, max 2 typefaces, multi-signal feedback).
