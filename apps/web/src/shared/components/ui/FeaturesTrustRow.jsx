...
export default function FeaturesTrustRow() {
  ...
  return (
    <div className="mt-8 md:mt-16 border border-[var(--border-subtle)] rounded-xl bg-[var(--bg-surface)] p-6 md:p-8 shadow-[var(--shadow-sm)] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
      {/* Value 1 */}
      <div className="flex items-start gap-4">
        <div className="w-10 h-10 rounded-lg bg-[var(--brand-soft)] text-[var(--text-brand)] flex items-center justify-center shrink-0 border border-[var(--border-brand)]">
