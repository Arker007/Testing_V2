...
export default function StatCard({
  ...
  return (
    <Card
      variant="elevated"
      className={`p-6 relative overflow-hidden backdrop-blur-sm bg-white/95 dark:bg-[var(--surface,#161c24)] border border-slate-200/90 dark:border-[var(--border-subtle,rgba(242,242,242,0.12))] rounded-xl transition-all hover:border-[var(--brand-primary)]/40 ${className}`.trim()}
      {...props}
    >
