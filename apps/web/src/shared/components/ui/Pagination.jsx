  ...
  return (
    ...
    >
      <button
        ...
        className="p-2 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] text-[var(--text-primary)] disabled:opacity-40 disabled:cursor-not-allowed hover:bg-[var(--bg-surface-elevated)] transition-all cursor-pointer"
        ...
        p === "..." ? (
          ...
          <button
            ...
            className={`min-w-[36px] h-9 px-3 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              currentPage === p
                ? "bg-[#1E622A] dark:bg-[#6BBF54] text-white dark:text-slate-950 shadow-xs"
