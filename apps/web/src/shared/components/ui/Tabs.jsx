...
export default function Tabs({
  ...
  const activeClasses = {
    pills:
      "bg-[var(--brand-primary,#6BBF54)] text-slate-950 shadow-md border border-[var(--brand-primary,#6BBF54)]",
    underline:
      "border-b-2 border-[var(--brand-primary,#6BBF54)] text-[var(--brand-primary,#6BBF54)] font-black",
    solid:
