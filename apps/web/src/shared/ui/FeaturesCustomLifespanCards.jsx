...
import customManufacturingBg from "../../assets/images/backgrounds/custom_manufacturing_bg_1785866818566.jpg";
import fiftyYearsBadge from "../../assets/images/brand/fifty_years_badge_1785866853287.jpg";
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="md:col-span-3 rounded-[var(--radius-card,8px)] border border-[var(--border-card)] bg-[var(--navy-dark)] p-6 md:p-8 shadow-xl relative overflow-hidden group flex flex-col md:flex-row items-center gap-6 md:gap-8 min-h-[220px]"
      >
