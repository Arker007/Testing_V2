...
export default function Alert({
  ...
  const statusSubtle = {
    ...
    brand: "bg-[var(--brand-soft)] border-[var(--brand-border)] text-[var(--text-brand)]",
  ...
  const statusSolid = {
    ...
    warning: "bg-[var(--color-warning)] text-white border-transparent",
  ...
  const statusLeftAccent = {
    ...
    success: "border-l-4 border-l-[var(--color-success)] bg-[var(--success-bg)] border-[var(--success-border)] text-[var(--success-text)]",
    warning: "border-l-4 border-l-[var(--color-warning)] bg-[var(--warning-bg)] border-[var(--warning-border)] text-[var(--warning-text)]",
    danger: "border-l-4 border-l-[var(--danger-500)] bg-[var(--danger-bg)] border-[var(--danger-border)] text-[var(--danger-text)]",
    brand: "border-l-4 border-l-[var(--brand-primary)] bg-[var(--brand-soft)] border-[var(--brand-border)] text-[var(--text-brand)]",
