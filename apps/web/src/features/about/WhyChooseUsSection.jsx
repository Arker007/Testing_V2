      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-3 flex">
            <div className="w-full h-[400px] lg:h-auto min-h-[380px] lg:min-h-[540px] rounded-2xl overflow-hidden shadow-2xl border border-white/10 flex">
              <img
          ...
          <div className="lg:col-span-4 bg-white/[0.04] border border-white/10 rounded-2xl p-8 sm:p-10 flex flex-col justify-between backdrop-blur-sm shadow-xl min-h-[440px] lg:min-h-[540px]">
            <div>
              ...
              <div className="h-[2px] w-12 bg-[#77D986] my-6" />
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            {/* Feature 1 */}
            <div className="group bg-white/[0.04] border border-white/10 hover:border-[#77d986]/40 hover:bg-white/[0.07] rounded-2xl p-6 sm:p-8 flex flex-col justify-between shadow-lg transition-all duration-300">
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#77d986]/10 border border-[#77d986]/20 flex items-center justify-center text-[#77d986] mb-5 shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="h-[2px] w-8 bg-[#77D986] mb-4" />
