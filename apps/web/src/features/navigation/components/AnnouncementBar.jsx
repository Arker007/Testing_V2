  ...
  return (
    <div className={styles.announcementBar}>
      <div className={styles.announcementInner}>
        <span>
          <Icon icon="carbon:recycle" className="w-4 h-4 text-emerald-400 inline align-middle mr-1" />
        ...
        <Link to="/contact" className={styles.announcementLink}>
          Get Free Quote <Icon icon="carbon:arrow-right" className="w-3.5 h-3.5 inline ml-1" />
        </Link>
      </div>
    </div>
  );
