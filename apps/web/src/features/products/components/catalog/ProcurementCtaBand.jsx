    ...
    <section className="pt-8 pb-4 cta-section">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-[var(--radius-btn,8px)] border border-slate-200/90 dark:border-white/15 bg-slate-100/80 dark:bg-white/5 hover:bg-slate-200/80 dark:hover:bg-white/10 text-slate-800 dark:text-slate-200 font-bold text-sm transition-colors shadow-2xs"
        >
