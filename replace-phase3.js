...
const iconMapping = {
  ...
  // Additional icons from the grep output
  'solar:restart-circle-linear': 'carbon:renew',
  'solar:cpu-bolt-linear': 'carbon:chip',
  'solar:chair-2-linear': 'carbon:seat',
  'solar:target-linear': 'carbon:bullseye',
  'solar:eye-linear': 'carbon:view',
  'solar:medal-ribbons-star-linear': 'carbon:badge',
  'solar:sun-fog-linear': 'carbon:sun',
  'solar:history-linear': 'carbon:time',
  'solar:settings-linear': 'carbon:settings',
  'solar:star-linear': 'carbon:star',
  'solar:cpu-linear': 'carbon:chip',
...
const dirs = [
  ...
  "apps/web/src/features/manufacturing"
];
